...
public class Types {
  ...
  public static ArrayList<ACTIONS> AVAILABLE_ACTIONS = new ArrayList<ACTIONS>() {{
    ...
    add(ACTIONS.ACTION_LEFT_FIRE);
    add(ACTIONS.ACTION_RIGHT_FIRE);
    add(ACTIONS.ACTION_THRUST_FIRE);
    add(ACTIONS.ACTION_THRUST_LEFT);
    add(ACTIONS.ACTION_THRUST_RIGHT);
    add(ACTIONS.ACTION_THRUST_LEFT_FIRE);
    add(ACTIONS.ACTION_THRUST_RIGHT_FIRE);
  }};
}
